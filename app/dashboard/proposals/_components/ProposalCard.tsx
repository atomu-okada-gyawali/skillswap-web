...
export default function ProposalCard({
  ...
  const senderId =
    typeof proposal.senderId === "object"
      ? proposal.senderId?._id
      : proposal.senderId;
  const receiverId =
    typeof proposal.receiverId === "object"
      ? proposal.receiverId?._id
      : proposal.receiverId;
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <span className="ml-2 font-medium text-gray-900">
                      {typeof proposal.offeredSkill === "object" &&
                      proposal.offeredSkill
                        ? proposal.offeredSkill.title
                        : proposal.offeredSkill}
                    </span>
